        ...
        <div class=" position-relative" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-3" style="text-align:center;">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 display-5 text-white"><span class="text-primary"></span></h1>
                    <h5 style="color: white;">Hotel</h5>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse" >
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="admin_view_students.php" class="nav-item nav-link">View Customer</a>
